...
def cube_sum(x,y):
    return x+y**2            #x -принимает текущее значение суммы квадратов , y- элемент который нужно возвести в квадрат
...
def x_on_x(element):                 # для 2го варианта через map
    return element**2
...
result = reduce(cube_sum,numbers,0)
print(result)
