...
# а вот их русские аналоги "АаВСсЕеНКМОоРрТХху". Напишите программу, которая для трёх букв из данных списков букв определяет,
...
result = [input() for i in range(3)]
if result[0] in en and result[1] in en and result[2] in en:
    print('en')
elif result[0] in ru and result[1] in ru and result[2] in ru:
    print('ru')
else:
    print('mix')