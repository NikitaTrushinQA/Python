...
# Первым элементом именованного кортежа является фамилия ученика,
# вторым — имя,
# третьим — класс.
...
group_iter=groupby(sorted(students,key=lambda x:x[1]))

max_result = max(group_iter)
print(max_result[0].name)