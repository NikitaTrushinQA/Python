...
# Первым элементом именованного кортежа является имя пользователя,
# вторым — фамилия,
# третьим — адрес электронной почты,
# четвертым — статус оформленной подписки.
